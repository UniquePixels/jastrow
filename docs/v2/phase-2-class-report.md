...
| **Unlinked `Ib.` citations** — **SHIPPED 2026-09-06** as `unlinked-bare-anaphor` | **2,119 anchors across 1,750 entries** (of 2,819 sites / 2,179 entries; 701 declines, all for want of an anchored antecedent) | `the` = 50,353 on two independent bases; scope 2,820 of 2,820 in `senses[].definition`; the walk scored 1,857 of 1,859 same-place against the linker | `conf:high` — needed link-target case 10 and a new `ORDERED` declaration in the registry |
