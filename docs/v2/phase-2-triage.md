...
| 2.3 created hints | [phase-2-created-hints.md](phase-2-created-hints.md) — 35 of the 67 created hints retired as one tokenizer defect; the remaining 37 on 35 entries adjudicated real |
