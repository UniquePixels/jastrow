...
Generated by `bun pipeline:migrate` over 32512 entries: every review and patch row of the run, by whether it must be resolved before v2 is published (consolidation spec §3.1.1). Deferred rows become tracker issues; notes do not.
...
## Before publication (311)

### headword-unparsed (309)
