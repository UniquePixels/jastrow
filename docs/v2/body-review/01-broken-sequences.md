...
| D00470 | דִּיבּוּר | 2 | …R. s. 38 ד׳ אחדים mysterious words (accounts), v. אֶחָד. Cant. R. l. c.; a. fr. V. דָּבָר. **—2)** | I believe the existing 2) sense in source data, is actualy a second sense of the plural with an implicit 1) which we will add for this project.  Confirm  |
