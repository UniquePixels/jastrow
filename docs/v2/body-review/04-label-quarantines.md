...
| --- | --- | --- | --- | --- |
| D00341 | דּוּר I | `[1)` | (entry start) **[1)** to form a circle or enclosure (v. Fl. to Levy Talm. Dict. I, p. 440ᵃ sq.).—Denom. דּוּר II, דּוֹר, דִּירָה &c.… | Text surrounds this sense in [].  Not sure what meaning this implies.  Likely should move to the beginning of the sense text to keep the notation… 1) [to form a....] - This will be a source text deviation on our part for display purposes. |
