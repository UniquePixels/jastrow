...
| 2026-09-21 | [`docs/decisions.md`](../decisions.md) added: one index of all 154 rulings across the eleven id schemes, each row carrying what the ruling drops, its home and its status against the code ([#104](https://github.com/UniquePixels/jastrow/issues/104), review §8). R1–R11 are §9 of that index. A new ruling is a row there first, then a section here. |
