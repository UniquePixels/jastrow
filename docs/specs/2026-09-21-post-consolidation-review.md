...
6. **Admin edits.** Patches with new entry-data ops, or plain file edits merged by §3.2? *Default: plain edits + merge; patches stay for source-shape defects; record `author` in the record.*
