# Sweep Agent Prompt — v9

- **Version:** `v9` — record verbatim in every patch's
  `prompt_version`. Supersedes [sweep-v8.md](sweep-v8.md) (residue
  batch 03); tranche outputs record which version produced them.
...
- **Sign-off:** maintainer, 2026-09-04 — approved for dispatch after
  residue batch 03, whose report
  (`data/patches/tranches/residue-01/report-batch-03.md`) lists the
  findings behind the two rows added here. Everything outside the
  v8 → v9 changelog is v8 verbatim.
...
| Prompt version | `v9`; copy verbatim into every patch's `prompt_version` |
