...
interface Pattern {
	 ...
	 * (triage: docs/archive/pattern-triage.md), why it was routed, and
	 * why it was kept or dropped as a cutover blocker. Not confined to
	 * `discarded` rows, as this said until step 11 — `candidate` rows
	 * carried one long before, and every row the step-11 triage ruled
	 * records that ruling here. */
	reason?: string;
