 ...
 * It reads truth, the page index and the slug index, never the source
 * snapshot, so it belongs to the unit tier.
 */
import { expect, it } from 'bun:test';
import { loadPageIndex } from './page.ts';
import { loadAliases, loadSlugIndex } from './slug-index.ts';
